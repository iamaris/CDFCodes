...
set DFC_BOOK           [ getenv DFC_BOOK        "none" ]

#
# Specify the tcl for generator, output file name and
# initial/final random seeds for random number streams
#
set GENERATOR_TCL      [ getenv GENERATOR_TCL "./mc_Pythia_msub230_slha.tcl" ]
set OUTPUT_FILE        [ getenv OUTPUT_FILE   "cdfSim_dgamma.root" ]
...
source $SIM_TCL_DIR/setup_evtgen.tcl
...
###########################################################################
#set ADD_MINBIAS_MEAN [ getenv ADD_MINBIAS_MEAN       "1" ]
