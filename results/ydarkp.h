...
// Tue Sep 27 10:49:47 2011 by ROOT version 4.00/08
// from TChain Photon/
//////////////////////////////////////////////////////////
...
Int_t ydarkp::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t ydarkp::LoadTree(Int_t entry)
{
