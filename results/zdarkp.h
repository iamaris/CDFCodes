...
// Sat Sep 24 16:35:51 2011 by ROOT version 4.00/08
// from TChain Photon/
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           eb_NPositrons;
   Int_t           eb_Good[10];   //[eb_NPositrons]
   Float_t         eb_TotalEt[10];   //[eb_NPositrons]
   Float_t         eb_Et[10];   //[eb_NPositrons]
   Float_t         eb_E[10];   //[eb_NPositrons]
   Float_t         eb_TrackPt[10];   //[eb_NPositrons]
   Float_t         eb_Nasl[10];   //[eb_NPositrons]
   Float_t         eb_Nssl[10];   //[eb_NPositrons]
   Float_t         eb_HadEm[10];   //[eb_NPositrons]
   Float_t         eb_Iso[10];   //[eb_NPositrons]
   Float_t         eb_Lshr[10];   //[eb_NPositrons]
   Float_t         eb_EP[10];   //[eb_NPositrons]
   Float_t         eb_DelXQ[10];   //[eb_NPositrons]
   Float_t         eb_DelZ[10];   //[eb_NPositrons]
   Float_t         eb_Z0[10];   //[eb_NPositrons]
   Float_t         eb_Chi2Strip[10];   //[eb_NPositrons]
   Int_t           eb_DetectorCode;
   Int_t           eb_TrackNumber;
   Float_t         eb_ClusterEmEt[10];   //[eb_NPositrons]
   Float_t         eb_ClusterHadEt[10];   //[eb_NPositrons]
   Float_t         eb_Charge[10];   //[eb_NPositrons]
   Float_t         eb_TrackEta[10];   //[eb_NPositrons]
   Float_t         eb_TrackPhi[10];   //[eb_NPositrons]
   Float_t         eb_TrackPhi2[10];   //[eb_NPositrons]
   Float_t         eb_Px[10];   //[eb_NPositrons]
   Float_t         eb_Py[10];   //[eb_NPositrons]
   Float_t         eb_Pz[10];   //[eb_NPositrons]
   Float_t         eb_P0[10];   //[eb_NPositrons]
   Int_t           m_NMuons;
   Int_t           m_Good[11];   //[m_NMuons]
   Int_t           m_TrackNumber[11];   //[m_NMuons]
   Int_t           m_NCmuHits[11];   //[m_NMuons]
   Int_t           m_NCmpHits[11];   //[m_NMuons]
   Int_t           m_NCmxHits[11];   //[m_NMuons]
   Int_t           m_NBmuHits[11];   //[m_NMuons]
   Float_t         m_TrackPt[11];   //[m_NMuons]
   Float_t         m_Iso[11];   //[m_NMuons]
   Float_t         m_CmuDelX[11];   //[m_NMuons]
   Float_t         m_CmpDelX[11];   //[m_NMuons]
   Float_t         m_CmxDelX[11];   //[m_NMuons]
   Float_t         m_BmuDelX[11];   //[m_NMuons]
   Float_t         m_HasCmuStub[11];   //[m_NMuons]
   Float_t         m_HasCmpStub[11];   //[m_NMuons]
   Float_t         m_HasCmxStub[11];   //[m_NMuons]
   Float_t         m_HasBmuStub[11];   //[m_NMuons]
   Float_t         m_TrackBcPt[11];   //[m_NMuons]
   Float_t         m_EmEnergy[11];   //[m_NMuons]
   Float_t         m_HadEnergy[11];   //[m_NMuons]
   Float_t         m_Z0[11];   //[m_NMuons]
   Float_t         m_D0[11];   //[m_NMuons]
   Float_t         m_mupt[11];   //[m_NMuons]
   Int_t           m_NSvxHits[11];   //[m_NMuons]
   Float_t         m_d0Corr[11];   //[m_NMuons]
   Float_t         m_Charge[11];   //[m_NMuons]
   Float_t         m_TrackEta[11];   //[m_NMuons]
   Float_t         m_TrackPhi[11];   //[m_NMuons]
   Float_t         m_TrackPhi2[11];   //[m_NMuons]
   Float_t         m_Px[11];   //[m_NMuons]
   Float_t         m_Py[11];   //[m_NMuons]
   Float_t         m_Pz[11];   //[m_NMuons]
   Float_t         m_P0[11];   //[m_NMuons]
   Int_t           mb_NAMuons;
   Int_t           mb_Good[13];   //[mb_NAMuons]
   ...
   Float_t         mb_mupt[11];   //[m_NMuons]
   Int_t           mb_NSvxHits[11];   //[m_NMuons]
   Float_t         mb_d0Corr[11];   //[m_NMuons]
...
Int_t zdarkp::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t zdarkp::LoadTree(Int_t entry)
{
...
void zdarkp::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("e_Good",e_Good);
   ...
   fChain->SetBranchAddress("eb_Good",eb_Good);
   ...
   fChain->SetBranchAddress("m_Good",m_Good);
   ...
   fChain->SetBranchAddress("mb_Good",mb_Good);
...
Bool_t zdarkp::Notify()
{
   ...
   b_e_Good = fChain->GetBranch("e_Good");
   ...
   b_eb_Good = fChain->GetBranch("eb_Good");
   ...
   b_m_Good = fChain->GetBranch("m_Good");
   ...
   b_mb_Good = fChain->GetBranch("mb_Good");
