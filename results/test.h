...
// Fri Sep 16 11:47:40 2011 by ROOT version 4.00/08
// from TTree Photon/My Dark Photon Ntuples
// found on file: TDarkPhoton_Ntuple_10.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           eb_NPositrons;
   Float_t         eb_TotalEt[13];   //[eb_NPositrons]
   Float_t         eb_Et[13];   //[eb_NPositrons]
   Float_t         eb_E[13];   //[eb_NPositrons]
   Float_t         eb_TrackPt[13];   //[eb_NPositrons]
   Float_t         eb_Nasl[13];   //[eb_NPositrons]
   Float_t         eb_Nssl[13];   //[eb_NPositrons]
   Float_t         eb_HadEm[13];   //[eb_NPositrons]
   Float_t         eb_Iso[13];   //[eb_NPositrons]
   Float_t         eb_Lshr[13];   //[eb_NPositrons]
   Float_t         eb_EP[13];   //[eb_NPositrons]
   Float_t         eb_DelXQ[13];   //[eb_NPositrons]
   Float_t         eb_DelZ[13];   //[eb_NPositrons]
   Float_t         eb_Z0[13];   //[eb_NPositrons]
   Float_t         eb_Chi2Strip[13];   //[eb_NPositrons]
   Int_t           eb_DetectorCode;
   Int_t           eb_TrackNumber;
   Float_t         eb_ClusterEmEt[13];   //[eb_NPositrons]
   Float_t         eb_ClusterHadEt[13];   //[eb_NPositrons]
   Float_t         eb_Charge[13];   //[eb_NPositrons]
   Float_t         eb_TrackEta[13];   //[eb_NPositrons]
   Float_t         eb_TrackPhi[13];   //[eb_NPositrons]
   Float_t         eb_TrackPhi2[13];   //[eb_NPositrons]
   Float_t         eb_Px[13];   //[eb_NPositrons]
   Float_t         eb_Py[13];   //[eb_NPositrons]
   Float_t         eb_Pz[13];   //[eb_NPositrons]
   Float_t         eb_P0[13];   //[eb_NPositrons]
   Int_t           m_NMuons;
...
Int_t test::GetEntry(Int_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t test::LoadTree(Int_t entry)
{
